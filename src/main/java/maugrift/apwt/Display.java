...
public class Display extends JFrame implements KeyListener
{
    ...
    /**
     * Creates a {@link Display} to wrap a constructed {@link asciiPanel.AsciiPanel}.
     *
     * @param panel the {@link asciiPanel.AsciiPanel} to wrap with the {@link Display}
     */
    ...
    /**
     * Writes a String to this {@link Display}'s {@link asciiPanel.AsciiPanel}, using the default foreground and
     * background colors.
     *
    ...
    /**
     * Writes a character to this {@link Display}'s {@link asciiPanel.AsciiPanel}, using the default foreground and
     * background colors.
     *
     * @param c     the char to write
     * @param point the point, in characters, at which the character will be written
     */
    ...
    /**
     * Writes a {@link maugrift.apwt.glyphs.ColorChar} to this {@link Display}'s {@link asciiPanel.AsciiPanel}.
     *
     * @param cc    the {@link maugrift.apwt.glyphs.ColorChar} to write
     * @param point the point, in characters, at which the {@link maugrift.apwt.glyphs.ColorChar} will be written
     */
    public void write(Coord point, ColorChar cc)
    {
        panel.write(cc.getChar(), point.x, point.y, cc.getForeground(), cc.getBackground());
    }

    /**
     * Writes an array of Strings to this {@link Display}'s {@link asciiPanel.AsciiPanel}, with each String on the line
     * below the previous.
     *
     * @param s     the Strings to write
     * @param point the point, in characters, at which the first String will be written
     */
    public void write(Coord point, String... s)
    {
    ...
    /**
     * Writes a String to this {@link Display}'s {@link asciiPanel.AsciiPanel}, using the colors defined in the {@link
     * maugrift.apwt.glyphs.ColorString}.
     *
     * @param s      the String to write
     * @param point  the point, in characters, at which the String will be written
     * @param colors the colors of the first {@link maugrift.apwt.glyphs.ColorChar} in this {@link
     *               maugrift.apwt.glyphs.ColorString} will be used on all matching characters of the String printed; if
     *               a character is not found in the {@link maugrift.apwt.glyphs.ColorString}, default colors will be
     *               used instead
     */
    public void write(Coord point, ColorString colors, String s)
    {
        ...
        for (int i = 0; i < s.length(); i++)
        {
            ...
            else
            {
                ...
                panel.write(cur, point.x + i, point.y, curColors.getForeground(), curColors.getBackground());
            }
        }
    }
     ...
     * Display}'s {@link asciiPanel.AsciiPanel}.
     *
     * @param s     the {@link maugrift.apwt.glyphs.ColorString} to write
     * @param point the point, in characters, at which the {@link maugrift.apwt.glyphs.ColorString} will be written
     */
    public void write(Coord point, ColorString s)
    {
        ...
        for (int i = 0; i < chars.size(); i++)
        {
            ...
            panel.write(chars.get(i).getChar(), point.x + i, point.y, chars.get(i).getForeground(),
                    chars.get(i).getBackground());
        }
    }

    /**
     * Writes an array of {@link maugrift.apwt.glyphs.ColorString ColorStrings} to this {@link Display}'s {@link
     * asciiPanel.AsciiPanel}, with each {@link maugrift.apwt.glyphs.ColorString} on the line below the previous.
     *
     * @param s     the {@link maugrift.apwt.glyphs.ColorString ColorStrings} to write
     * @param point the point, in characters, at which the first {@link maugrift.apwt.glyphs.ColorString} will be
     *              written
     */
    public void write(Coord point, ColorString... s)
    {
    ...
    /**
     * Writes an array of Strings to the center of this {@link Display}'s {@link asciiPanel.AsciiPanel}.
     *
     * @param s     the Strings to write
    ...
    public void writeCenter(Coord point, String... s)
    {
        ...
        for (int line = 0; line < s.length; line++)
        {
            if (s[line] != null)
            {
                write(Coord.get(point.x - (s[line].length() / 2), point.y - (s.length / 2) + line + 1), s[line]);
            }
        }
    }
     ...
     *
     * @param s     the {@link maugrift.apwt.glyphs.ColorString ColorStrings} to write
     * @param point the point at which the first {@link maugrift.apwt.glyphs.ColorString ColorString} will be written
     */
    public void writeCenter(Coord point, ColorString... s)
    {
        ...
        for (int line = 0; line < s.length; line++)
        {
            if (s[line] != null)
            {
                ...
                write(Coord.get(point.x - (copy.length() / 2), point.y - (s.length / 2) + line), copy);
            }
        }
    }
     ...
     *
     * @param s the {@link maugrift.apwt.glyphs.ColorString ColorStrings} to write
     * @param y the line on which the first {@link maugrift.apwt.glyphs.ColorString ColorString} will be written
     */
    ...
    /**
     * Returns true if this {@link Display}'s {@link asciiPanel.AsciiPanel} contains the given Coord.
     *
     * @param point the Coord to check for containment on the {@link asciiPanel.AsciiPanel}
    ...
    /**
     * Returns true if this {@link Display}'s {@link asciiPanel.AsciiPanel} contains the given x value, in characters.
     *
     * @param x the x value, in characters, to check for containment on the {@link asciiPanel.AsciiPanel}
    ...
    /**
     * Returns true if this {@link Display}'s {@link asciiPanel.AsciiPanel} contains the given y value, in characters.
     *
     * @param y the y value, in characters, to check for containment on the {@link asciiPanel.AsciiPanel}
    ...
    /**
     * Returns the width of this {@link Display}'s {@link asciiPanel.AsciiPanel} in characters.
     *
     * @return the width of this {@link Display}'s {@link asciiPanel.AsciiPanel} in characters
     */
    ...
    /**
     * Returns the height of this {@link Display}'s {@link asciiPanel.AsciiPanel} in characters.
     *
     * @return the height of this {@link Display}'s {@link asciiPanel.AsciiPanel} in characters
     */
     ...
     *
     * @param end1   the first endpoint; must be a different point than the second endpoint, have one axis value in
     *               common, and be on the display
     * @param end2   the second endpoint; must be a different point than the first endpoint, have one axis value in
     *               common, and be on the display
     ...
     */
    public boolean drawLine(Coord end1, Coord end2, Line border)
    {
        if (end1.equals(end2))
        {
            throw new IllegalArgumentException("Both endpoints may not be the " + "same point");
        }
        ...
        if ((end1.x == end2.x && border.horizontal) || (end1.y == end2.y && !border.horizontal))
        {
        ...
        write(end1, new ColorChar(border.end1, border.getForeground(), border.getBackground()));
        write(end2, new ColorChar(border.end2, border.getForeground(), border.getBackground()));
        ...
        if (!border.horizontal)
        {
            ...
            {
                write(Coord.get(end1.x, i), new ColorChar(border.line, border.getForeground(), border.getBackground()));
            }
        }
        else
        {
            ...
            for (int i = start + 1; i < end; i++)
            {
                write(Coord.get(i, end1.y), new ColorChar(border.line, border.getForeground(), border.getBackground()));
            }
        }
    ...
    /**
     * Draws a {@link Border}  between two specified corners to the provided {@link maugrift.apwt.Display}, filled with
     * the provided fill color.
     *
     * @param corner1 the first corner; must be a different point than the second corner, share no axis values, and be
     *                on the display
     * @param corner2 the second corner; must be a different point than the first corner, share no axis values, and be
     *                on the display
     ...
     */
    public boolean drawBorder(Coord corner1, Coord corner2, Border border, Color fill)
    {
        ...
        write(tl, new ColorChar(border.cornerTL, border.getForeground(), border.getBackground()));
        write(tr, new ColorChar(border.cornerTR, border.getForeground(), border.getBackground()));
        write(bl, new ColorChar(border.cornerBL, border.getForeground(), border.getBackground()));
        write(br, new ColorChar(border.cornerBR, border.getForeground(), border.getBackground()));

        for (int x = tl.x + 1; x < tr.x; x++)
        {
            getPanel().write(border.edgeT, x, tl.y, border.getForeground(), border.getBackground());
            getPanel().write(border.edgeB, x, bl.y, border.getForeground(), border.getBackground());
        }

        for (int y = tl.y + 1; y < bl.y; y++)
        {
            getPanel().write(border.edgeL, tl.x, y, border.getForeground(), border.getBackground());
            getPanel().write(border.edgeR, tr.x, y, border.getForeground(), border.getBackground());
        }
     ...
     * @return true if the {@link Border} was successfully drawn
     */
    public boolean drawBorder(Coord corner1, Coord corner2, int width, Color fill)
    {
    ...
    /**
     * Draws a {@link Border} of the default width between two specified corners. No fill will be performed.
     *
     * @param corner1 the first corner; must be a different point than the second corner, share no axis values, and be
     *                on the display
     * @param corner2 the second corner; must be a different point than the first corner, share no axis values, and be
