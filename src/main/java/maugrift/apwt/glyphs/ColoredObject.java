...
/**
 * A parent class for any Object that specifies a foreground and background color.
 *
 * @author Maugrift
 */
public abstract class ColoredObject
{
    ...
    /**
     * Creates a {@link ColoredObject} with a foreground color but no background color.
     *
     * @param f the color of the foreground
     */
