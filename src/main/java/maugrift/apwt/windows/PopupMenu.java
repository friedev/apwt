...
{
    /**
     * Creates a {@link PopupMenu} from a {@link PopupWindow}, initial selection, and selection colors.
     *
     ...
     */
    public PopupMenu(PopupWindow window, int initialSelection, Color foreground, Color background)
    {
        super(window, initialSelection, foreground, background);
    }

    /**
     * Creates a {@link PopupMenu} from a {@link PopupWindow} and selection colors, starting with the first item
     * selected.
     *
     * @param window     the {@link Menu}'s {@link Window}
     * @param foreground the foreground color of selected items
