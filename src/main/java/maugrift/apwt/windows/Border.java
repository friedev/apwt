...
/**
 * A class containing the characters necessary to draw a rectangle; fully customizable.
 *
 * @author Maugrift
 */
public class Border extends ColoredObject
{
     ...
     */
    public Border(char t, char b, char l, char r, char tl, char tr, char bl, char br, Color fc, Color bc)
    {
        super(fc, bc);
    ...
    /**
     * Creates a {@link Border} with explicitly-defined characters and a foreground color.
     *
     * @param t  the character on the top edge
     * @param b  the character on the bottom edge
     * @param l  the character on the left edge
     ...
     * @param fc the color of the characters
     */
    public Border(char t, char b, char l, char r, char tl, char tr, char bl, char br, Color fc)
    {
        this(t, b, l, r, tl, tr, bl, br, fc, null);
    }

    /**
     * Creates a {@link Border} with explicitly-defined characters, but no specified colors.
     *
     * @param t  the character on the top edge
     * @param b  the character on the bottom edge
     * @param l  the character on the left edge
     ...
     * @param br the character in the bottom-right corner
     */
    public Border(char t, char b, char l, char r, char tl, char tr, char bl, char br)
    {
        this(t, b, l, r, tl, tr, bl, br, null, null);
    }

    /**
     * Creates a {@link Border} with one character used on every edge and corner, along with specified colors.
     *
    ...
    /**
     * Creates a {@link Border} with one character used on every edge and corner, along with a specified foreground
     * color.
     *
     * @param c  the character to use on every part of the border
     * @param fc the color of the characters
    ...
    /**
     * Creates a {@link Border} with one character used on every edge and corner, but no specified colors.
     *
     * @param c the character to use on every part of the border
     */
    ...
    /**
     * Creates a {@link Border} with lines of the specified width, along with specified colors.
     *
    ...
    {
        this(LineChars.horizontal(lineWidth), LineChars.horizontal(lineWidth), LineChars.vertical(lineWidth),
                LineChars.vertical(lineWidth), LineChars.topLeft(lineWidth), LineChars.topRight(lineWidth),
                LineChars.bottomLeft(lineWidth), LineChars.bottomRight(lineWidth), f, b);
    }

    /**
     * Creates a {@link Border} with lines of the specified width, along with a specified foreground color.
     *
     * @param lineWidth the width of the line characters to use, must be 1 or 2
     * @param f         the color of the characters
     */
    ...
    /**
     * Creates a {@link Border} with lines of the specified width, but no specified colors.
     *
     * @param lineWidth the width of the line characters to use, must be 1 or 2
     */
