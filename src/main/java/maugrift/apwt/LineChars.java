...
/**
 * A collection of methods and constants for easy retrieval of line characters of varying width.
 *
 * @author Maugrift
 */
public abstract class LineChars
{
     ...
     *
     * @param horizontal if true, will return a horizontal line; if false, will return a vertical line
     * @param width      the number of lines in the character to return; must be 1 or 2
     * @return a line character with the specified properties; the UNKNOWN character if invalid
     */
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return a horizontal line character with the specified width; the UNKNOWN character if invalid
     */
    public static char horizontal(int width)
    {
        ...
        {
            case 1:
                return LINE1_HORIZONTAL;
            case 2:
                return LINE2_HORIZONTAL;
            default:
                return UNKNOWN;
        }
    }
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return a vertical line character with the specified width; the UNKNOWN character if invalid
     */
    public static char vertical(int width)
    {
        ...
        {
            case 1:
                return LINE1_VERTICAL;
            case 2:
                return LINE2_VERTICAL;
            default:
                return UNKNOWN;
        }
    }
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return a top-left corner character with the specified width; the UNKNOWN character if invalid
     */
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return a top-right corner character with the specified width; the UNKNOWN character if invalid
     */
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return a bottom-left corner character with the specified width; the UNKNOWN character if invalid
     */
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return a bottom-right corner character with the specified width; the UNKNOWN character if invalid
     */
    ...
    /**
     * Returns a line character with the provided horizontal width with a perpendicular line of the specified width
     * extending upwards.
     *
     ...
     * @return a split line character with the specified widths; the UNKNOWN character if invalid
     */
    public static char splitUp(int widthHorizontal, int widthVertical)
    {
        switch (widthHorizontal)
        {
            case 1:
                ...
                {
                    case 1:
                        return LINE1_SPLIT_U;
                    case 2:
                        return LINE1_SWITCH_U;
                    default:
                        return UNKNOWN;
                }
            case 2:
                ...
                {
                    case 1:
                        return LINE2_SWITCH_U;
                    case 2:
                        return LINE2_SPLIT_U;
                    default:
                        return UNKNOWN;
                }
            default:
    ...
    public static char splitDown(int widthHorizontal, int widthVertical)
    {
        switch (widthHorizontal)
        {
            case 1:
                ...
                {
                    case 1:
                        return LINE1_SPLIT_D;
                    case 2:
                        return LINE1_SWITCH_D;
                    default:
                        return UNKNOWN;
                }
            case 2:
                ...
                {
                    case 1:
                        return LINE2_SWITCH_D;
                    case 2:
                        return LINE2_SPLIT_D;
                    default:
                        return UNKNOWN;
                }
            default:
    ...
    /**
     * Returns a line character with the provided vertical width with a perpendicular line of the specified width
    ...
    public static char splitLeft(int widthVertical, int widthHorizontal)
    {
        switch (widthVertical)
        {
            case 1:
                ...
                {
                    case 1:
                        return LINE1_SPLIT_L;
                    case 2:
                        return LINE1_SWITCH_L;
                    default:
                        return UNKNOWN;
                }
            case 2:
                ...
                {
                    case 1:
                        return LINE2_SWITCH_L;
                    case 2:
                        return LINE2_SPLIT_L;
                    default:
                        return UNKNOWN;
                }
            default:
    ...
    public static char splitRight(int widthVertical, int widthHorizontal)
    {
        switch (widthVertical)
        {
            case 1:
                ...
                {
                    case 1:
                        return LINE1_SPLIT_R;
                    case 2:
                        return LINE1_SWITCH_R;
                    default:
                        return UNKNOWN;
                }
            case 2:
                ...
                {
                    case 1:
                        return LINE2_SWITCH_R;
                    case 2:
                        return LINE2_SPLIT_R;
                    default:
                        return UNKNOWN;
                }
            default:
     ...
     *
     * @param width the number of lines in the character to return; must be 1 or 2
     * @return an intersection line character with the specified width; the UNKNOWN character if invalid
     */
    public static char center(int width)
    {
        ...
        {
            case 1:
                return LINE1_CENTER1;
            case 2:
                return LINE2_CENTER2;
            default:
                return UNKNOWN;
        }
    }
    ...
    /**
     * Returns the intersection character with the vertical line and horizontal lines of the specified width.
     *
     * @param horizontal the number of horizontal lines in the character to return; must be 1 or 2
     * @param vertical   the number of vertical lines in the character to return; must be 1 or 2
     * @return an intersection line character with the specified widths; the UNKNOWN character if invalid
     */
