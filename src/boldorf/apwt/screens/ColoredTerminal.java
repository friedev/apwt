 ...
 * input.
 * @param <Output> the type of {@link boldorf.apwt.windows.Window} used by
 * the {@link Terminal}
 */
        ...
        extends Terminal<Output>
{
     ...
     * {@link boldorf.apwt.windows.Window Window},
     ...
     * {@link boldorf.apwt.windows.Border borders} and the
     * prompt
    ...
    /**
     * Creates an {@link ColoredTerminal} with the given
     * {@link boldorf.apwt.windows.Window Window} and maximum length,
     * but no prompt.
     * @param output the {@link Terminal}'s output window
     * @param length the {@link Terminal}'s maximum length, counting Window
     * {@link boldorf.apwt.windows.Border borders}
     */
    ...
    /**
     * Creates an {@link ColoredTerminal} with the given
     * {@link boldorf.apwt.windows.Window Window} and
     * prompt, using the width of the
     * {@link boldorf.apwt.Display} as the maximum length.
     * @param output the {@link Terminal}'s output window
     * @param prompt the {@link Terminal}'s prompt
     */
     ...
     * and the width of the {@link boldorf.apwt.Display} as the maximum
     * length.
     * @param output the {@link Terminal}'s output window
     */
