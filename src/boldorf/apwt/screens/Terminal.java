...
/**
 * A basic {@link boldorf.apwt.windows.Window} where the operator can type
...
public abstract class Terminal<Output extends Window> extends ConfirmationScreen
{
    ...
    /**
     * The {@link boldorf.apwt.windows.Window} through which all output is
     * displayed.
     */
     ...
     * {@link boldorf.apwt.windows.Window}, prompt, and maximum length.
     ...
     * {@link boldorf.apwt.windows.Window}.
